              ...
              <div className="px-6 pb-6 mt-[-3rem] flex flex-col md:flex-row items-end md:items-end gap-6 relative z-10">
                  ...
                  <div className="flex-1 min-w-0 pb-2 text-center md:text-left">
                      ...
                      <p className="text-slate-500 flex items-center justify-center md:justify-start gap-2 text-sm mt-1">
                          <MapPin className="h-4 w-4" /> Colombo, Sri Lanka • Joined Jan 2026
                      </p>
                  </div>
                  <div className="pb-2 w-full md:w-auto">
                      <Button className="w-full md:w-auto bg-[#DD6B20] hover:bg-[#C05615]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             ...
             <div className="md:col-span-2 space-y-6">
                 <div className="grid grid-cols-3 gap-4">
                     {[
                         { label: "Points", value: "1,200", icon: Star, color: "text-yellow-500", bg: "bg-yellow-50" },
                         { label: "Items Found", value: "12", icon: Trophy, color: "text-orange-500", bg: "bg-orange-50" },
                         { label: "Matches", value: "8", icon: Award, color: "text-emerald-500", bg: "bg-emerald-50" },
                     ].map((stat, i) => (
             ...
             <div className="space-y-6">
                <Card className="border-none shadow-sm h-full">
                    ...
                    <CardContent className="space-y-4 text-sm text-slate-600">
                        <p>
                            Graphic designer and photographer based in Colombo. I often find things while doing street photography. Happy to help reunite lost items!
                        </p>
