...
export default function SearchPage() {
  ...
  const subcategoryOptions =
    selectedCategory === "All"
      ...
      : [
          ...
          ...Array.from(
            new Set([
              ...(ITEM_CATEGORIES[selectedCategory] || []),
              ...items
  ...
  const filteredItems = items.filter((item) => {
    ...
    return matchesQuery && matchesCategory && matchesSubcategory && matchesType;
  });
        ...
        <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
          <div>
            ...
            <p className="text-slate-500">
              Find what you lost or help return what you found.
            </p>
          </div>
          <Button
            variant="outline"
                    ...
                    <div>
                      <div className="flex justify-between items-start mb-1">
                        <div className="flex flex-wrap gap-1">
                          ...
                          {item.subcategory ? (
                            <span className="text-xs font-medium text-slate-600 bg-slate-100 px-2 flex py-0.5 rounded-md self-center">
                              {item.subcategory}
                            </span>
                          ) : null}
                        </div>
